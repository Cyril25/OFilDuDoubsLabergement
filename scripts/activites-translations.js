const dataTranslations = {
    ...
    en: {
        ...
        chateau_joux_title: "Château de Joux",
        chateau_joux_description: "Medieval fortress with a panoramic view and guided tours retracing a thousand years of history.",
        fort_saint_antoine_title: "Fort Saint-Antoine",
        fort_saint_antoine_description: "A unique place for Comté cheese aging, visit to discover the secrets of making this exceptional cheese.",
        ...
        source_bleue_title: "Blue Spring",
        source_bleue_description: "A pleasant walk leading to a natural spring nestled in greenery. A peaceful place to relax and enjoy nature, accessible from Malbuisson.",
        accrobranche_metabief_title: "Tree Climbing in Métabief",
        accrobranche_metabief_description: "Adventure courses in the trees with different levels for kids and adults. Guaranteed thrills in the heart of the Métabief forest.",
        lac_saint_point_title: "Lake Saint-Point",
        ...
        maison_michaud_title: "Michaud House",
        maison_michaud_description: "Immerse yourself in the rural life of the past in this Comtoise farmhouse turned eco-museum. Events all year round.",
        mont_dor_title: "Mont d’Or",
    ...
    de: {
        ...
        lac_remoray_title: "See von Remoray",
        ...
        maison_reserve_title: "Das Reservatshaus",
        ...
        fonderie_cloches_title: "Obertino Glockengießerei",
        fonderie_cloches_description: "Entdecken Sie die Kunst der Glockenherstellung in dieser renommierten Gießerei. Geführte Touren ermöglichen es Ihnen, dieses traditionelle Handwerk zu erkunden.",
        chateau_joux_title: "Schloss Joux",
        chateau_joux_description: "Mittelalterliche Festung mit Panoramablick und Führungen, die tausend Jahre Geschichte nachzeichnen.",
        fort_saint_antoine_title: "Fort Saint-Antoine",
        ...
        station_metabief_description: "Winteraktivitäten (Skifahren, Schneeschuhwandern) und Sommeraktivitäten (Mountainbiken, Rodeln, Wandern) für Natur- und Adrenalinliebhaber.",
        source_bleue_title: "Blaue Quelle",
        source_bleue_description: "Ein angenehmer Spaziergang, der zu einer natürlichen Quelle führt, die im Grünen eingebettet ist. Ein friedlicher Ort, um sich zu entspannen und die Natur zu genießen, zugänglich von Malbuisson.",
        accrobranche_metabief_title: "Baumklettern in Métabief",
        accrobranche_metabief_description: "Abenteuerparcours in den Bäumen mit verschiedenen Schwierigkeitsgraden für Kinder und Erwachsene. Nervenkitzel garantiert im Herzen des Waldes von Métabief.",
        lac_saint_point_title: "See Saint-Point",
        lac_saint_point_description: "Der drittgrößte natürliche See Frankreichs, ideal zum Schwimmen, Wandern, Radfahren und für Wasseraktivitäten. Viele Zugänge von Malbuisson, Saint-Point und Labergement.",
        distillerie_guy_title: "Guy-Destillerie",
        ...
        maison_michaud_title: "Haus Michaud",
        maison_michaud_description: "Tauchen Sie ein in das ländliche Leben vergangener Zeiten in diesem Comtoise-Bauernhaus, das in ein Ökomuseum umgewandelt wurde. Veranstaltungen das ganze Jahr über.",
        mont_dor_title: "Mont d’Or",
