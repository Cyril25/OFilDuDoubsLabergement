const dataTranslations = {
    fr: {
        ...
        coni_fer_description: "Embarquez pour une balade rétro sur le chemin de fer touristique le plus haut de France, entre forêts et tourbières (Les Hôpitaux-Neufs, ~10 min).",
        bateaux_lac_title: "Bateaux du Lac Saint-Point",
        bateaux_lac_description: "Croisière douce et silencieuse en bateau électrique sur l'un des plus grands lacs naturels de France, au départ de Saint-Point/Malbuisson.",
        parapente_title: "Parapente au Mont d'Or",
        parapente_description: "Vol découverte en parapente au-dessus du Haut-Doubs depuis le Mont d'Or, pour admirer lacs et sommets vus du ciel (~10 min).",
        base_grangettes_title: "Base nautique des Grangettes",
        base_grangettes_description: "Voile, paddle, kayak et pédalos sur le lac Saint-Point, rive des Grangettes. Location de matériel en saison.",
        ski_nordique_title: "Ski de fond & raquettes (espace nordique)",
        ski_nordique_description: "L'hiver, le massif se parcourt en ski de fond ou en raquettes sur les pistes nordiques de Métabief et du Mont d'Or.",
        sentier_morbier_title: "Les Sentiers du Morbier",
        sentier_morbier_description: "Balade-jeu immersive autour du fromage Morbier au départ de la Fruitière des Lacs : une aventure ludique pour toute la famille (Morbier Explor Games).",
        title: "Activités",
        ...
        luge_rails_title: "Parc ludique de Métabief",
        luge_rails_description: "L'été, la station se transforme en parc de loisirs : luge sur rails, tyrolienne, trampolines et de nombreux jeux pour petits et grands.",
        ...
        ferme_batailleuse_description: "Ferme pédagogique associative à 930 m d'altitude : chèvres, vaches montbéliardes, cochons, poules… Fromages de chèvre vendus à la boutique et Comté bio. Une visite idéale en famille. Membre du réseau Paysans de nature.",
    ...
    en: {
        ...
        coni_fer_description: "Hop aboard a vintage ride on France's highest tourist railway, through forests and peat bogs (Les Hôpitaux-Neufs, ~10 min).",
        bateaux_lac_title: "Lake Saint-Point Boats",
        bateaux_lac_description: "A gentle, silent cruise by electric boat on one of France's largest natural lakes, departing from Saint-Point/Malbuisson.",
        parapente_title: "Paragliding at Mont d'Or",
        parapente_description: "A tandem discovery flight over the Haut-Doubs from Mont d'Or, to admire lakes and peaks from the sky (~10 min).",
        base_grangettes_title: "Les Grangettes Water Sports Centre",
        base_grangettes_description: "Sailing, paddleboarding, kayaking and pedal boats on Lake Saint-Point, Les Grangettes shore. Equipment rental in season.",
        ski_nordique_title: "Cross-country skiing & snowshoeing (nordic area)",
        ski_nordique_description: "In winter, explore the massif on cross-country skis or snowshoes along the nordic trails of Métabief and Mont d'Or.",
        sentier_morbier_title: "The Morbier Trails",
        sentier_morbier_description: "An immersive walking game about Morbier cheese starting from the Fruitière des Lacs: a fun adventure for the whole family (Morbier Explor Games).",
        title: "Activities",
        ...
        luge_rails_title: "Métabief Fun Park",
        luge_rails_description: "In summer, the resort becomes a leisure park: rail sledging, zip line, trampolines and many games for young and old.",
        ...
        ferme_batailleuse_title: "Ferme de la Batailleuse",
        ferme_batailleuse_description: "Associative educational farm at 930 m: goats, Montbéliarde cows, pigs, hens… Goat cheeses sold in the farm shop and organic Comté. A great visit for families. Member of the Paysans de nature network.",
    ...
    de: {
        ...
        coni_fer_description: "Steigen Sie ein zu einer nostalgischen Fahrt auf der höchsten Touristenbahn Frankreichs, durch Wälder und Moore (Les Hôpitaux-Neufs, ~10 Min.).",
        bateaux_lac_title: "Boote auf dem Lac Saint-Point",
        bateaux_lac_description: "Eine sanfte, lautlose Fahrt im Elektroboot auf einem der größten Naturseen Frankreichs, ab Saint-Point/Malbuisson.",
        parapente_title: "Gleitschirmfliegen am Mont d'Or",
        parapente_description: "Ein Schnupperflug im Gleitschirm über das Haut-Doubs vom Mont d'Or aus, mit Blick auf Seen und Gipfel aus der Luft (~10 Min.).",
        base_grangettes_title: "Wassersportzentrum Les Grangettes",
        base_grangettes_description: "Segeln, SUP, Kajak und Tretboote auf dem Lac Saint-Point am Ufer von Les Grangettes. Materialverleih in der Saison.",
        ski_nordique_title: "Langlauf & Schneeschuhwandern (Nordic-Gebiet)",
        ski_nordique_description: "Im Winter lässt sich das Massiv auf Langlaufskiern oder Schneeschuhen auf den Loipen von Métabief und Mont d'Or erkunden.",
        sentier_morbier_title: "Die Morbier-Pfade",
        sentier_morbier_description: "Ein interaktives Wanderspiel rund um den Morbier-Käse ab der Fruitière des Lacs: ein spielerisches Abenteuer für die ganze Familie (Morbier Explor Games).",
        title: "Aktivitäten",
        ...
        luge_rails_title: "Freizeitpark Métabief",
        luge_rails_description: "Im Sommer verwandelt sich die Station in einen Freizeitpark: Schienenrodelbahn, Seilrutsche, Trampoline und viele Spiele für Groß und Klein.",
        ...
        ferme_batailleuse_title: "Ferme de la Batailleuse",
        ferme_batailleuse_description: "Pädagogischer Vereinsbauernhof auf 930 m: Ziegen, Montbéliarde-Kühe, Schweine, Hühner… Ziegenkäse im Hofladen und Bio-Comté. Ein ideales Ausflugsziel für Familien. Mitglied im Netzwerk Paysans de nature.",
    ...
    nl: {
        ...
        coni_fer_description: "Stap aan boord voor een retrorit op de hoogste toeristische spoorlijn van Frankrijk, door bossen en veengebieden (Les Hôpitaux-Neufs, ~10 min).",
        bateaux_lac_title: "Boten op het Lac Saint-Point",
        bateaux_lac_description: "Een rustige, stille cruise met een elektrische boot op een van de grootste natuurlijke meren van Frankrijk, vanaf Saint-Point/Malbuisson.",
        parapente_title: "Paragliden op de Mont d'Or",
        parapente_description: "Een kennismakingsvlucht boven de Haut-Doubs vanaf de Mont d'Or, om meren en toppen vanuit de lucht te bewonderen (~10 min).",
        base_grangettes_title: "Watersportcentrum Les Grangettes",
        base_grangettes_description: "Zeilen, suppen, kajakken en waterfietsen op het Lac Saint-Point, oever van Les Grangettes. Materiaalverhuur in het seizoen.",
        ski_nordique_title: "Langlaufen & sneeuwschoenwandelen (nordic gebied)",
        ski_nordique_description: "In de winter verken je het massief op langlaufski's of sneeuwschoenen op de nordic pistes van Métabief en de Mont d'Or.",
        sentier_morbier_title: "De Morbier-paden",
        sentier_morbier_description: "Een meeslepend wandelspel rond de Morbier-kaas vanaf de Fruitière des Lacs: een leuk avontuur voor het hele gezin (Morbier Explor Games).",
        title: "Activiteiten",
        ...
        luge_rails_title: "Pretpark Métabief",
        luge_rails_description: "In de zomer verandert het station in een recreatiepark: railrodelen, tokkelbaan, trampolines en talloze spellen voor jong en oud.",
        ...
        ferme_batailleuse_title: "Ferme de la Batailleuse",
        ferme_batailleuse_description: "Educatieve boerderij (vereniging) op 930 m: geiten, Montbéliarde-koeien, varkens, kippen… Geitenkaas in de hoevewinkel en biologische Comté. Een ideaal uitje voor gezinnen. Lid van het netwerk Paysans de nature.",
    ...
    es: {
        ...
        coni_fer_description: "Súbete a un paseo retro por el ferrocarril turístico más alto de Francia, entre bosques y turberas (Les Hôpitaux-Neufs, ~10 min).",
        bateaux_lac_title: "Barcos del Lago Saint-Point",
        bateaux_lac_description: "Un crucero suave y silencioso en barco eléctrico por uno de los mayores lagos naturales de Francia, desde Saint-Point/Malbuisson.",
        parapente_title: "Parapente en el Mont d'Or",
        parapente_description: "Un vuelo de iniciación en parapente sobre el Haut-Doubs desde el Mont d'Or, para admirar lagos y cumbres desde el cielo (~10 min).",
        base_grangettes_title: "Base náutica de Les Grangettes",
        base_grangettes_description: "Vela, paddle surf, kayak y patinetes acuáticos en el lago Saint-Point, orilla de Les Grangettes. Alquiler de material en temporada.",
        ski_nordique_title: "Esquí de fondo y raquetas (espacio nórdico)",
        ski_nordique_description: "En invierno, recorre el macizo con esquís de fondo o raquetas por las pistas nórdicas de Métabief y el Mont d'Or.",
        sentier_morbier_title: "Los Senderos del Morbier",
        sentier_morbier_description: "Un juego-paseo inmersivo sobre el queso Morbier desde la Fruitière des Lacs: una aventura divertida para toda la familia (Morbier Explor Games).",
        title: "Actividades",
        ...
        luge_rails_title: "Parque lúdico de Métabief",
        luge_rails_description: "En verano, la estación se convierte en un parque de ocio: tobogán sobre raíles, tirolina, camas elásticas y muchos juegos para grandes y pequeños.",
        ...
        ferme_batailleuse_title: "Ferme de la Batailleuse",
        ferme_batailleuse_description: "Granja educativa asociativa a 930 m: cabras, vacas montbéliardas, cerdos, gallinas… Quesos de cabra en la tienda de la granja y Comté ecológico. Una visita ideal en familia. Miembro de la red Paysans de nature.",
    ...
    it: {
        ...
        coni_fer_description: "Salite a bordo per una gita retrò sulla ferrovia turistica più alta di Francia, tra boschi e torbiere (Les Hôpitaux-Neufs, ~10 min).",
        bateaux_lac_title: "Battelli del Lago Saint-Point",
        bateaux_lac_description: "Una crociera dolce e silenziosa su un battello elettrico in uno dei più grandi laghi naturali di Francia, da Saint-Point/Malbuisson.",
        parapente_title: "Parapendio al Mont d'Or",
        parapente_description: "Un volo di scoperta in parapendio sopra l'Haut-Doubs dal Mont d'Or, per ammirare laghi e cime dal cielo (~10 min).",
        base_grangettes_title: "Base nautica di Les Grangettes",
        base_grangettes_description: "Vela, paddle, kayak e pedalò sul lago Saint-Point, riva di Les Grangettes. Noleggio attrezzatura in stagione.",
        ski_nordique_title: "Sci di fondo e ciaspole (area nordica)",
        ski_nordique_description: "In inverno, il massiccio si percorre con gli sci di fondo o le ciaspole sulle piste nordiche di Métabief e del Mont d'Or.",
        sentier_morbier_title: "I Sentieri del Morbier",
        sentier_morbier_description: "Una passeggiata-gioco immersiva sul formaggio Morbier dalla Fruitière des Lacs: un'avventura divertente per tutta la famiglia (Morbier Explor Games).",
        title: "Attività",
        ...
        luge_rails_title: "Parco giochi di Métabief",
        luge_rails_description: "In estate, la stazione diventa un parco divertimenti: slittino su rotaia, zip line, trampolini e tanti giochi per grandi e piccini.",
        ...
        ferme_batailleuse_title: "Ferme de la Batailleuse",
        ferme_batailleuse_description: "Fattoria didattica associativa a 930 m: capre, mucche montbéliarde, maiali, galline… Formaggi di capra in vendita nello spaccio e Comté biologico. Una visita ideale per famiglie. Membro della rete Paysans de nature.",
    ...
    pt: {
        ...
        coni_fer_description: "Embarque num passeio retro na ferrovia turística mais alta de França, entre florestas e turfeiras (Les Hôpitaux-Neufs, ~10 min).",
        bateaux_lac_title: "Barcos do Lago Saint-Point",
        bateaux_lac_description: "Um cruzeiro suave e silencioso em barco elétrico num dos maiores lagos naturais de França, a partir de Saint-Point/Malbuisson.",
        parapente_title: "Parapente no Mont d'Or",
        parapente_description: "Um voo de descoberta de parapente sobre o Haut-Doubs a partir do Mont d'Or, para admirar lagos e cumes vistos do céu (~10 min).",
        base_grangettes_title: "Base náutica de Les Grangettes",
        base_grangettes_description: "Vela, paddle, caiaque e gaivotas no lago Saint-Point, margem de Les Grangettes. Aluguer de material na época.",
        ski_nordique_title: "Esqui de fundo e raquetes (espaço nórdico)",
        ski_nordique_description: "No inverno, percorra o maciço de esqui de fundo ou raquetes nas pistas nórdicas de Métabief e do Mont d'Or.",
        sentier_morbier_title: "Os Trilhos do Morbier",
        sentier_morbier_description: "Um jogo-passeio imersivo sobre o queijo Morbier a partir da Fruitière des Lacs: uma aventura divertida para toda a família (Morbier Explor Games).",
        title: "Atividades",
        ...
        luge_rails_title: "Parque lúdico de Métabief",
        luge_rails_description: "No verão, a estação transforma-se num parque de lazer: trenó sobre carris, slide, trampolins e muitos jogos para miúdos e graúdos.",
        ...
        ferme_batailleuse_title: "Ferme de la Batailleuse",
        ferme_batailleuse_description: "Quinta pedagógica associativa a 930 m: cabras, vacas montbéliardes, porcos, galinhas… Queijos de cabra na loja da quinta e Comté biológico. Uma visita ideal para famílias. Membro da rede Paysans de nature.",
